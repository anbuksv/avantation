// @ts-nocheck
// Adapted from generate-schema.json https://github.com/Nijikokun/generate-schema
 ...
 function getPropertyType(value) {
    // If the value is null - default to string. "null" is NOT applicable
    // for OpenAPI types.
     if(value === null) {
         return 'string'
     }
 ...
 function processObject(object, output, nested) {
     ...
     for (var key in object) {
         ...
         // If the type is unknown - default to string. "null" is NOT applicable
         // for OpenAPI types.
